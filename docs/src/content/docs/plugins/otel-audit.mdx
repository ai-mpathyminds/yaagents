...
documented in [Audit and Observability](/yaagents/architecture/audit-and-observability/) —
operators read a single reference instead of two diverging schemas.
...
See [Audit and Observability](/yaagents/architecture/audit-and-observability/) for the
full bench baseline archive, detailed latency breakdowns, and the end-to-end
correlation-id join walkthrough across gateway and SDK audit records.
