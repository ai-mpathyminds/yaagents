...
<CardGrid>
  ...
  <LinkCard title="Observability" href="/yaagents/architecture/audit-and-observability/" description="Correlation-ID propagation, audit spans, and Prometheus metrics." />
